...
public class GUILogged extends JFrame {
	...
	public GUILogged(String username) {
		...
		btnCreate.setBackground(new Color(102, 51, 255));
		...
		btnEdit.setBackground(new Color(102, 51, 255));
		...
		btnList.setBackground(new Color(102, 51, 255));
		...
		btnInvite.setBackground(new Color(102, 51, 255));
